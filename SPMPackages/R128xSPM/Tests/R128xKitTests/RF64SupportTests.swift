...
final class RF64SupportTests: XCTestCase {
    ...
    func testRF64FileDetectionWithInvalidFile() {
        ...
        XCTAssertFalse(RF64Support.isRF64File(at: "/nonexistent/file.wav"), "Should handle non-existent files gracefully")
        ...
        do {
            ...
            XCTAssertFalse(RF64Support.isRF64File(at: emptyURL.path), "Should handle empty files gracefully")
        } catch {
    ...
    func testRF64InfoParsing() throws {
        ...
        XCTAssertEqual(info.dataSize, 0x0000000100000000, "Should parse correct data size")
    ...
    func testRF64InfoParsingWithWAVFile() throws {
        ...
        XCTAssertThrowsError(try RF64Support.parseRF64Info(at: wavURL.path)) { error in
            ...
            if let rf64Error = error as? RF64Support.RF64Error {
                XCTAssertEqual(rf64Error, RF64Support.RF64Error.notRF64File, "Should indicate file is not RF64")
            }
        }
    }
...
final class RF64IntegrationTests: XCTestCase {
    ...
    func testExtAudioProcessorRF64ErrorHandling() throws {
        ...
        do {
            let _ = try await processor.processAudioFile(at: rf64URL.path)
