...
@MainActor
@Suite("EBUR128Tests - 4", .serialized)
struct EBUR128TestsDelta {
  @Test
  func testEBUR128StandardCompliance() async throws {
    ...
    #expect(
      abs(loudness - -23.0) < 2.0, "Loudness should be approximately -23 LUFS, got \(loudness)"
    )
  }
